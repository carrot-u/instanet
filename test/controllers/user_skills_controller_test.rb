...
class UserSkillsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_skill" do
    assert_difference('UserSkill.count') do
      post user_skills_url, params: { user_skill: { level: @user_skill.level, name: @user_skill.name, user_id: @user_skill.user_id } }
    end
  ...
  test "should update user_skill" do
    patch user_skill_url(@user_skill), params: { user_skill: { level: @user_skill.level, name: @user_skill.name, user_id: @user_skill.user_id } }
