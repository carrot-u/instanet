...
class UserBadgesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_badge" do
    assert_difference('UserBadge.count') do
      post user_badges_url, params: { user_badge: { active: @user_badge.active, badge: @user_badge.badge, description: @user_badge.description, issued_by_id: @user_badge.issued_by_id, name: @user_badge.name, src: @user_badge.src, user_id: @user_badge.user_id } }
    end
  ...
  test "should update user_badge" do
    patch user_badge_url(@user_badge), params: { user_badge: { active: @user_badge.active, badge: @user_badge.badge, description: @user_badge.description, issued_by_id: @user_badge.issued_by_id, name: @user_badge.name, src: @user_badge.src, user_id: @user_badge.user_id } }
